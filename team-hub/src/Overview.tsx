...
const steps = [
  {
    ...
    icon: ShieldCheck,
    body: "사내환경 설정이 되지 않아 진행되지 않는 Python 패키지 설치, 사내 NASCA 보안으로 인해 Python으로 Excel 데이터를 조회할 수 없는 문제. 사내 엔지니어가 겪는 이 두 상황을 해커톤용 가상 환경과 합성 데이터로 재현했습니다.",
    flow: ["사내환경 설정 · Python 설치", "NASCA 보안 · Excel 조회", "가상 환경에서 재현"],
