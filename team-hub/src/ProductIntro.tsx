...
export default function ProductIntro() {
  return <div className="product-intro overview-simple">
    <section className="impact-hero"><h2>내 Agent가 고생한 삽질을<br/>다른 팀원은 하지 않습니다.</h2><p>사내 환경 셋업, 보안 문서 접근, 사내 DB 연결 등 AI Agent가 막히는 여러 문제를<br/>팀 공용 Skill을 찾아 적용하고, 새로 푼 문제는 다음 팀원이 쓸 수 있게 Skill로 남깁니다.</p></section>
